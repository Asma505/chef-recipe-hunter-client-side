...
const Login = () => {
    ...
    return (
        <div className='w-2/3 mx-auto my-52 bg-gray-300 py-10'>
            <h3 className='text-center text-3xl font-bold'>Please Login</h3>
            
            <form onSubmit={handleLogin}>
                <div className='text-center'>
                    <label>Email</label>
                    <input className='block w-1/2 mx-auto mb-5' type="email" name="email" id="" placeholder=' Your Email' required />


                    <label>Password</label>
                    <input className='block w-1/2 mx-auto mb-5' type="password" name="password" id="" placeholder=' Enter Password' required />
                </div>
